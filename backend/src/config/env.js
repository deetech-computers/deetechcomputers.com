...
export const HUBTEL_MERCHANT_ACCOUNT =
  process.env.HUBTEL_MERCHANT_ACCOUNT || process.env.HUBTEL_POS_SALES_ID || "";
export const HUBTEL_BASE_URL =
  process.env.HUBTEL_BASE_URL || "https://payproxyapi.hubtel.com";
export const HUBTEL_CALLBACK_TOKEN = process.env.HUBTEL_CALLBACK_TOKEN || "";
export const HUBTEL_STATUS_TOKEN = process.env.HUBTEL_STATUS_TOKEN || "";
