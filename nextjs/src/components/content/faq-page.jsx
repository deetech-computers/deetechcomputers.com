...
const items = [
  ...
  ["How much does delivery cost?", "Delivery is free on all laptop orders. For non-laptop orders, delivery is GHC 30 when the product subtotal is below GHC 300, GHC 50 for GHC 300 to GHC 999, GHC 100 for GHC 1,000 to GHC 1,999, and free again once the product subtotal reaches GHC 2,000 or more."],
