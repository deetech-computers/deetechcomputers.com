...
const BRAND_LOGO_MOBILE_SRC = "/favicon-removebg-preview-mobile.png";
      ...
      <header className="site-header">
        <div className="header-topbar">
          <div className="shell header-topbar__inner">
            ...
            <span>Non-laptops: Free below 60 | GHC 30 for 60-299 | GHC 50 for 300-999 | GHC 100 for 1,000-1,999 | Free at 2,000+</span>
          </div>
        </div>
