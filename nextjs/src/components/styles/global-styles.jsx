...
.account-affiliate-meta {
  margin: 0;
  display: grid;
  gap: 10px;
}
.account-affiliate-meta div {
  display: grid;
...
.account-affiliate-meta dt {
  color: var(--muted);
  font-size: 0.86rem;
  font-weight: 700;
}
.account-affiliate-meta dd {
  margin: 0;
  color: #111;
  font-weight: 900;
  text-transform: uppercase;
...
.account-affiliate-stat {
  ...
  min-height: 180px;
  padding: 20px;
  border: 2px solid rgba(24, 79, 39, 0.88);
  background: rgba(255,255,255,0.92);
}
.account-affiliate-stat.is-gold,
.account-affiliate-stat.is-amber {
  border-color: #c58310;
}
.account-affiliate-stat.is-emerald {
  border-color: #178f55;
}
.account-affiliate-stat.is-blue {
  border-color: #0d56da;
}
.account-affiliate-stat__head {
  display: flex;
  align-items: center;
  gap: 10px;
  color: #6c6255;
...
.account-affiliate-stat.is-gold .account-affiliate-stat__icon,
.account-affiliate-stat.is-amber .account-affiliate-stat__icon {
  background: rgba(197, 131, 16, 0.14);
  color: #a46905;
}
.account-affiliate-stat.is-emerald .account-affiliate-stat__icon {
  background: rgba(23, 143, 85, 0.12);
  color: #178f55;
}
.account-affiliate-stat.is-blue .account-affiliate-stat__icon {
...
.account-affiliate-breakdown > div {
  display: grid;
  gap: 8px;
  padding: 22px;
}
.account-affiliate-breakdown > div + div {
  border-left: 1px solid #eadfce;
}
.account-affiliate-breakdown span {
  color: var(--muted);
  font-size: 0.88rem;
  font-weight: 800;
}
.account-affiliate-breakdown strong {
  font-size: 1.15rem;
  overflow-wrap: anywhere;
}
.account-affiliate-breakdown p {
  margin: 0;
  color: #5f5547;
}
.account-mini-row,
...
.storefront-home {
  background:
    linear-gradient(180deg, #f5f6f7 0%, #f8f2e6 34%, #f5f6f7 68%);
}
.storefront-hero {
  padding: clamp(24px, 4vw, 52px) 0 clamp(18px, 3vw, 34px);
  overflow: hidden;
}
...
.storefront-hero__copy .section-kicker {
  color: #184f27;
}
...
.storefront-hero__copy .hero-copy {
  max-width: 58ch;
  margin: 0;
  color: #4f463c;
...
.storefront-hero__primary,
.storefront-hero__secondary {
  min-height: 48px;
  border-radius: 999px;
  padding: 0 20px;
  font-weight: 800;
...
.storefront-hero__primary {
  background: linear-gradient(180deg, #1d6a33 0%, #184f27 100%);
  border: 1px solid rgba(24, 79, 39, 0.24);
  color: #ffffff;
  box-shadow: 0 14px 34px rgba(24, 79, 39, 0.22);
}
.storefront-hero__secondary {
  display: inline-flex;
  align-items: center;
...
.storefront-hero__primary:hover,
.storefront-hero__secondary:hover,
.storefront-hero__quick-link:hover {
  transform: translateY(-1px);
}
.storefront-hero__quick-grid {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 10px;
  max-width: 560px;
}
.storefront-hero__quick-link {
  display: grid;
  gap: 5px;
  min-height: 78px;
  padding: 14px 15px;
  ...
  color: #1b1916;
  text-decoration: none;
  box-shadow: 0 12px 28px rgba(27, 25, 22, 0.05);
...
.storefront-hero__quick-link span {
  font-weight: 850;
}
.storefront-hero__quick-link small {
  color: #665d52;
  font-size: 0.82rem;
}
...
.storefront-hero .hero-banner {
  aspect-ratio: 16 / 8.4;
  border: 1px solid rgba(232, 224, 212, 0.92);
  border-radius: 16px;
  background: #ffffff;
  box-shadow: 0 24px 70px rgba(27, 25, 22, 0.12);
}
.storefront-hero .hero-banner__slide-media {
  background: #ffffff;
}
.storefront-hero .hero-banner__slide-fallback {
  background:
    linear-gradient(135deg, rgba(24, 79, 39, 0.88), rgba(27, 25, 22, 0.96)),
    linear-gradient(90deg, #f8f2e6 0%, #ffffff 100%);
}
.storefront-hero .hero-banner__arrow {
  width: 42px;
  height: 42px;
  color: #184f27;
  box-shadow: 0 12px 28px rgba(27, 25, 22, 0.16);
}
.storefront-hero .hero-banner__dots {
  bottom: 12px;
  background: rgba(255, 255, 255, 0.9);
  border: 1px solid rgba(232, 224, 212, 0.8);
}
.storefront-hero .hero-banner__dot::before {
  background: #d7c7ad;
}
.storefront-hero .hero-banner__dot:hover::before,
.storefront-hero .hero-banner__dot.is-active::before {
  background: #184f27;
}
.storefront-hero__media-note {
  justify-self: end;
  max-width: 520px;
  color: #665d52;
  font-size: 0.82rem;
...
.storefront-brand-strip {
  ...
  padding: clamp(18px, 3vw, 28px) 0 14px;
  border-block: 1px solid rgba(232, 224, 212, 0.76);
  background: rgba(255, 255, 255, 0.78);
}
.storefront-brand-strip__header {
  display: grid;
...
.storefront-brand-strip__header h2 {
  max-width: 780px;
  margin: 0;
  color: #1b1916;
...
.storefront-brand-strip__header .hero-copy {
  margin: 0;
  color: #665d52;
}
.storefront-brand-strip .home-logo-marquee__item {
  width: 142px;
  height: 70px;
...
.category-tile {
  border-radius: 16px;
  box-shadow: 0 18px 44px rgba(27, 25, 22, 0.12);
}
.category-tile__overlay {
  background:
    linear-gradient(180deg, rgba(27, 25, 22, 0.04) 0%, rgba(27, 25, 22, 0.18) 45%, rgba(27, 25, 22, 0.82) 100%);
}
.category-tile__cta {
  color: #f4d37b;
}
...
.homepage-products__section {
  ...
  border-radius: 16px;
  background: rgba(255, 255, 255, 0.74);
  box-shadow: 0 18px 50px rgba(27, 25, 22, 0.06);
}
.homepage-products__section-head h3 {
...
.homepage-products__view-all {
  min-height: 40px;
  padding: 0 14px;
  border: 1px solid rgba(24, 79, 39, 0.18);
  border-radius: 999px;
  background: #ffffff;
  color: #184f27;
  text-decoration: none;
...
.homepage-products .product-card {
  border: 1px solid #ece7de;
  border-radius: 14px;
  box-shadow: 0 10px 28px rgba(27, 25, 22, 0.05);
}
.homepage-products .product-card__media {
  background: #fbfaf7;
}
