...
.hero-grid, .filters-panel, .cart-layout, .account-grid, .product-detail, .footer-grid, .resource-grid {
...
.shop-drawer {
  ...
  min-height: 100svh; height: 100dvh; overflow: hidden;
}
.shop-drawer__header {
  display: flex; align-items: center; justify-content: space-between; gap: 12px;
  padding: max(18px, calc(env(safe-area-inset-top) + 12px)) 16px 18px; border-bottom: 1px solid #e6dfd3; background: #fff;
}
...
.shop-drawer__body {
  ...
  padding: 16px 16px max(20px, calc(env(safe-area-inset-bottom) + 20px));
  display: grid; gap: 18px;
}
.products-results {
  margin: 0;
...
.product-detail-loading__gallery {
  ...
  min-height: 520px;
  background:
    linear-gradient(90deg, rgba(248, 245, 240, 0.72), rgba(255, 255, 255, 0.92), rgba(248, 245, 240, 0.72));
  background-size: 220% 100%;
...
.product-detail-loading__summary span,
...
.product-gallery__main-loading {
  position: absolute;
  inset: 0;
  z-index: 1;
  pointer-events: none;
  background: linear-gradient(90deg, rgba(248, 245, 240, 0.08), rgba(255, 255, 255, 0.28), rgba(248, 245, 240, 0.08));
  background-size: 220% 100%;
...
.product-summary__stock-badge.is-in-stock {
  color: #0f6f3e;
  border-color: rgba(15, 111, 62, 0.48);
  background: rgba(15, 111, 62, 0.1);
}
...
.account-notification-empty-card {
  display: grid;
  justify-items: center;
  gap: 22px;
  width: min(680px, 100%);
...
.account-notification-empty-card__mark {
  position: relative;
  display: grid;
  width: 96px;
  height: 96px;
...
.account-notification-empty-card__mark > .account-dashboard__nav-icon {
  width: 44px;
  height: 44px;
  stroke-width: 2;
}
.account-notification-empty-card__mark span {
  position: absolute;
  right: 8px;
  bottom: 8px;
  display: grid;
...
.account-notification-empty-card__mark span .account-dashboard__nav-icon {
  width: 16px;
  height: 16px;
  stroke-width: 3;
}
.account-notification-empty-card h3 {
  margin: 0;
  color: #00401b;
  font-size: 1.8rem;
  line-height: 1.08;
}
.account-notification-empty-card p {
  max-width: 500px;
  margin: 0;
  color: #4b5550;
  font-size: 1rem;
...
.account-notification-empty-card__action {
  display: inline-flex;
  min-height: 56px;
  align-items: center;
  justify-content: center;
...
.account-notification-empty-card__action .account-dashboard__nav-icon {
  width: 19px;
  height: 19px;
  transition: transform 0.18s ease;
}
.account-notification-empty-card__action:hover .account-dashboard__nav-icon {
  transform: translateX(3px);
}
.account-notification-empty-card__footer {
...
.affiliate-command__metrics div {
  display: grid;
  gap: 6px;
  padding: 16px 18px;
...
.affiliate-command__metrics dt {
  color: #665d52;
  font-size: 0.84rem;
  font-weight: 800;
}
.affiliate-command__metrics dd {
  margin: 0;
  color: #184f27;
  font-size: 1.35rem;
  font-weight: 900;
...
@media (min-width: 981px) {
  ...
  .affiliate-command {
    ...
    border-radius: 0;
    background:
      radial-gradient(circle at 95% 90%, rgba(24, 79, 39, 0.11) 0 13%, transparent 14%),
      radial-gradient(circle at 88% 12%, rgba(217, 164, 65, 0.18), transparent 36%),
      linear-gradient(135deg, #ffffff 0%, #f9f4ea 100%);
    box-shadow: none;
  }
  .affiliate-command::after {
    display: none;
  ...
  .affiliate-command .affiliate-badge {
    min-height: 34px;
    margin-bottom: 18px;
    padding: 0 18px;
  ...
  .affiliate-code-card {
    ...
    box-shadow: 0 20px 54px rgba(27, 25, 22, 0.08);
  }
  .affiliate-code-card span {
    color: #665d52;
    font-size: 0.92rem;
...
@media (min-width: 981px) {
  ...
  .affiliate-command {
    ...
    background: #14552b;
    color: #ffffff;
    box-shadow: 0 18px 44px rgba(20, 85, 43, 0.18);
  }
  .affiliate-command::after {
    display: none;
  }
...
@media (min-width: 981px) {
  ...
  .affiliate-learn__step-icon svg,
  .affiliate-learn__tier-card h4 svg {
    width: 22px;
    height: 22px;
  }
  .affiliate-learn__commission li,
  ...
  .affiliate-analytics__row {
    grid-template-columns: minmax(110px, 0.42fr) minmax(0, 1fr) auto;
    padding: 10px 0;
    border-bottom: 1px solid #d9ddd3;
  }
  .affiliate-analytics__row:last-child {
    border-bottom: 0;
  }
  .affiliate-analytics__row div {
    background: #e8e0d4;
...
.account-affiliate-section__head {
  display: grid;
  gap: 6px;
  margin-bottom: 30px;
}
.account-affiliate-section__head h2 {
  margin: 0;
  color: #003714;
  font-size: clamp(2rem, 3vw, 2.5rem);
  line-height: 1.05;
}
.account-affiliate-section__head p {
  margin: 0;
  color: #4f565f;
  font-size: 1.02rem;
}
...
.account-affiliate-hero__copy {
  display: grid;
  gap: 24px;
}
.account-affiliate-hero h3 {
  max-width: 620px;
  margin: 0;
  color: #ffffff;
...
.account-affiliate-status.is-inactive {
  color: #ffe3a1;
}
.account-affiliate-hero__metrics {
  display: grid;
...
.account-affiliate-hero__metrics div {
  display: grid;
  gap: 6px;
  padding: 18px 20px;
...
.account-affiliate-hero__metrics dt {
  color: rgba(255, 255, 255, 0.48);
  font-size: 0.82rem;
  font-weight: 900;
}
.account-affiliate-hero__metrics dd {
  margin: 0;
  color: #f0c463;
  font-size: 1.55rem;
  font-weight: 900;
...
.account-affiliate-code-card > span {
  color: #5b5e59;
  font-size: 0.82rem;
  font-weight: 900;
  letter-spacing: 0.06em;
}
.account-affiliate-code-card div {
  display: grid;
  grid-template-columns: minmax(0, 1fr) auto;
  gap: 14px;
  align-items: center;
...
.account-affiliate-code-card .account-dashboard__nav-icon {
  width: 24px;
  height: 24px;
  color: #14552b;
}
.account-affiliate-code-card p {
  margin: 0;
  color: #8a8278;
  font-size: 0.8rem;
  font-style: italic;
...
.account-affiliate-stat.is-gold {
  border-left: 4px solid #d9a441;
}
.account-affiliate-stat .account-dashboard__nav-icon {
  width: 24px;
  height: 24px;
  color: #1d6a33;
}
.account-affiliate-stat.is-gold .account-dashboard__nav-icon {
  color: #d9a441;
}
.account-affiliate-stat.is-danger .account-dashboard__nav-icon {
  color: #c0392b;
}
.account-affiliate-stat > span {
  color: #384137;
  font-size: 0.77rem;
  font-weight: 900;
  line-height: 1.35;
...
.account-affiliate-stat strong {
  color: #14552b;
  font-size: clamp(1.45rem, 2.2vw, 1.95rem);
  line-height: 1.15;
  overflow-wrap: anywhere;
}
.account-affiliate-stat small {
  color: #746b60;
  font-size: 0.78rem;
  line-height: 1.35;
}
...
.account-affiliate-panel__head {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 18px;
}
.account-affiliate-panel__head h3 {
  margin: 0;
  color: #00401b;
  font-size: clamp(1.35rem, 2vw, 1.75rem);
}
.account-affiliate-panel__head .account-dashboard__nav-icon {
  width: 25px;
  height: 25px;
  color: #3d413c;
}
.account-affiliate-payout-box {
  display: grid;
  gap: 8px;
  place-items: center;
  min-height: 96px;
...
.account-affiliate-payout-box span {
  color: #4a4f57;
  font-size: 0.78rem;
  font-weight: 800;
}
.account-affiliate-payout-box strong {
  color: #00401b;
  font-size: 1.65rem;
}
...
.account-affiliate-checkline.is-ready {
  color: #1d6a33;
}
.account-affiliate-checkline .account-dashboard__nav-icon {
  width: 23px;
  height: 23px;
}
.account-affiliate-method {
  display: grid;
  grid-template-columns: 52px minmax(0, 1fr);
  gap: 14px;
  align-items: center;
...
.account-affiliate-method > .account-dashboard__nav-icon {
  width: 48px;
  height: 48px;
  padding: 12px;
  border-radius: 4px;
...
.account-affiliate-method strong {
  display: block;
  color: #14552b;
  font-weight: 900;
}
.account-affiliate-method span {
  display: block;
  margin-top: 4px;
  color: #4f565f;
  font-size: 0.9rem;
}
.account-affiliate-panel a {
  display: inline-flex;
  align-items: center;
  gap: 8px;
  width: fit-content;
...
.account-affiliate-panel a .account-dashboard__nav-icon {
  width: 17px;
  height: 17px;
}
.account-affiliate-panel--summary dl {
  display: grid;
  gap: 0;
  margin: 0;
}
.account-affiliate-panel--summary dl div {
  display: grid;
  grid-template-columns: minmax(0, 1fr) auto;
  gap: 18px;
  padding: 14px 0;
...
.account-affiliate-panel--summary dt {
  color: #4f565f;
}
.account-affiliate-panel--summary dd {
  margin: 0;
  color: #14552b;
  font-weight: 900;
  text-align: right;
}
.account-affiliate-panel--summary .primary-link {
  width: 100%;
  justify-content: center;
  min-height: 56px;
  margin-top: auto;
...
.account-affiliate-conversions__head {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 18px;
...
.account-affiliate-conversions__head h3 {
  margin: 0;
  color: #00401b;
  font-size: clamp(1.35rem, 2vw, 1.75rem);
}
.account-affiliate-conversions__head a {
  color: #14552b;
  font-size: 0.78rem;
  font-weight: 900;
  text-transform: uppercase;
...
.account-affiliate-conversions__table {
  display: grid;
}
.account-affiliate-conversions__row {
  display: grid;
...
.account-affiliate-conversions__row:last-child {
  border-bottom: 0;
}
...
.account-affiliate-conversions__row strong {
  color: #111827;
}
.account-affiliate-conversions__row em {
  display: inline-flex;
  width: fit-content;
  min-height: 24px;
  align-items: center;
...
.account-affiliate-conversions__row em.is-settled {
  background: #acf0b9;
  color: #16652f;
}
.account-affiliate-conversions__row em.is-pending {
  background: #7f2e45;
  color: #ffffff;
}
.account-affiliate-conversions__row em.is-cancelled {
  background: #f2d6d2;
  color: #9f2d21;
}
...
.account-wishlist-empty-card {
  display: grid;
  justify-items: center;
  gap: 24px;
  width: min(720px, 100%);
  margin: clamp(78px, 12vh, 140px) auto 0;
...
.account-wishlist-empty-card__mark {
  position: relative;
  display: grid;
  width: 128px;
  height: 128px;
...
.account-wishlist-empty-card__mark > .account-dashboard__nav-icon {
  width: 66px;
  height: 66px;
  stroke-width: 2.2;
}
.account-wishlist-empty-card__mark i {
  position: absolute;
  right: -18px;
  bottom: -8px;
  display: grid;
...
.account-wishlist-empty-card__mark i .account-dashboard__nav-icon {
  width: 26px;
  height: 26px;
}
.account-wishlist-empty-card h3 {
  margin: 0;
  color: #111827;
  font-size: 1.8rem;
  line-height: 1.12;
}
.account-wishlist-empty-card p {
  max-width: 430px;
  margin: 0;
  color: #4b5550;
  font-size: 1.05rem;
...
.account-wishlist-empty-card__action {
  display: inline-flex;
  width: min(100%, 360px);
  min-height: 64px;
  align-items: center;
  ...
  font-weight: 900;
  text-decoration: none;
  box-shadow: 0 10px 22px rgba(0, 64, 27, 0.2);
}
.account-wishlist-empty-card__categories {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 16px;
  width: 100%;
...
.account-wishlist-empty-card__categories a {
  display: grid;
  justify-items: start;
  gap: 14px;
  min-height: 120px;
...
.account-wishlist-empty-card__categories .account-dashboard__nav-icon {
  width: 30px;
  height: 30px;
  color: #17602d;
}
.account-wishlist-empty-card__footer {
  display: grid;
  justify-items: center;
  gap: 8px;
  margin: clamp(90px, 14vh, 150px) 0 0;
  padding-top: 28px;
  border-top: 1px solid #c1c9bd;
  color: #7d867d;
  font-size: 0.82rem;
...
.account-wishlist-empty-card__footer .account-dashboard__nav-icon {
  width: 22px;
  height: 22px;
  color: #7d867d;
}
.account-wishlist-empty-card__footer span {
...
.account-reviews-empty-card {
  display: grid;
  justify-items: center;
  gap: 22px;
  width: min(680px, 100%);
  margin: clamp(92px, 14vh, 170px) auto 0;
...
.account-reviews-empty-card__mark {
  position: relative;
  display: grid;
  width: 96px;
  height: 96px;
...
.account-reviews-empty-card__mark > .account-dashboard__nav-icon {
  width: 46px;
  height: 46px;
  stroke-width: 2.1;
}
.account-reviews-empty-card__mark i {
  position: absolute;
  right: -8px;
  bottom: -6px;
  display: grid;
...
.account-reviews-empty-card__mark i .account-dashboard__nav-icon {
  width: 18px;
  height: 18px;
}
.account-reviews-empty-card h3 {
  margin: 0;
  color: #00401b;
  font-size: 1.45rem;
  line-height: 1.15;
}
.account-reviews-empty-card p {
  max-width: 410px;
  margin: 0;
  color: #4b5550;
  line-height: 1.6;
}
.account-reviews-empty-card__action {
  display: inline-flex;
  min-width: 242px;
  min-height: 56px;
  align-items: center;
...
.account-reviews-empty-card__action .account-dashboard__nav-icon {
  width: 18px;
  height: 18px;
}
.account-reviews-empty-card__benefits {
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: 24px;
  width: 100%;
...
.account-reviews-empty-card__benefits span {
  display: grid;
  justify-items: center;
  gap: 8px;
  color: #3f4540;
...
.account-reviews-empty-card__benefits .account-dashboard__nav-icon {
  width: 24px;
  height: 24px;
  color: #1d6a33;
}
.account-reviews-empty-card__footer {
  margin: clamp(150px, 22vh, 230px) 0 0;
  color: #a0a39f;
  font-size: 0.72rem;
  font-weight: 900;
...
.account-orders-empty-card {
  ...
  border-radius: 8px;
  background:
    radial-gradient(circle at 50% 30%, rgba(230, 248, 235, 0.86), rgba(255, 255, 255, 0) 32%),
    #ffffff;
  text-align: center;
  box-shadow: 0 18px 55px rgba(17, 24, 39, 0.08);
}
.account-orders-empty-card__mark {
  position: relative;
  display: grid;
  width: 114px;
  height: 114px;
  place-items: center;
  color: rgba(24, 79, 39, 0.12);
}
.account-orders-empty-card__mark > .account-dashboard__nav-icon {
  width: 82px;
  height: 82px;
  stroke-width: 1.7;
}
.account-orders-empty-card__mark i {
  position: absolute;
  right: 2px;
  bottom: 12px;
  display: grid;
...
.account-orders-empty-card__mark i .account-dashboard__nav-icon {
  width: 24px;
  height: 24px;
}
.account-orders-empty-card h3 {
  margin: 0;
  color: #00401b;
  font-size: 1.45rem;
  line-height: 1.15;
}
.account-orders-empty-card p {
  max-width: 460px;
  margin: 0;
  color: #4b5550;
  font-size: 1rem;
...
.account-orders-empty-card__action {
  display: inline-flex;
  min-height: 58px;
  align-items: center;
  justify-content: center;
...
.account-orders-empty-card__action .account-dashboard__nav-icon {
  width: 19px;
  height: 19px;
}
.account-orders-empty-card__links {
  display: inline-flex;
  align-items: center;
  gap: 28px;
  margin-top: 18px;
...
.account-orders-empty-card__links a {
  display: inline-flex;
  align-items: center;
  gap: 7px;
  color: inherit;
...
.account-orders-empty-card__links a + a {
  padding-left: 28px;
  border-left: 1px solid #d7ddd2;
}
.account-orders-empty-card__links .account-dashboard__nav-icon {
  width: 17px;
  height: 17px;
}
.account-orders-empty-trust {
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: 28px;
  width: min(960px, 100%);
...
.account-orders-empty-trust article {
  display: grid;
  grid-template-columns: 34px minmax(0, 1fr);
  gap: 16px;
  align-items: center;
...
.account-orders-empty-trust .account-dashboard__nav-icon {
  width: 30px;
  height: 30px;
  color: #668a78;
}
.account-orders-empty-trust strong {
  display: block;
  color: #668a78;
  font-size: 0.95rem;
}
.account-orders-empty-trust span {
  color: #6f7773;
  font-size: 0.85rem;
}
.account-mobile-home {
...
@media (max-width: 640px) {
  ...
  .account-page-main.has-mobile-affiliates {
    width: 100%;
    max-width: none;
    margin: 0;
    padding: 0;
  ...
  .account-mobile-affiliates__head span {
    display: block;
    color: #252b24;
    font-size: 0.76rem;
    font-weight: 800;
  ...
  .account-mobile-affiliates__icon {
    width: 22px;
    height: 22px;
    flex: 0 0 auto;
  }
  .account-mobile-affiliates__body {
    display: grid;
    gap: 26px;
    padding: 18px 18px 26px;
  }
  .account-mobile-affiliates__hero {
    position: relative;
    display: grid;
    gap: 14px;
    overflow: hidden;
    ...
    background: #18572a;
    color: #a8d4ad;
    box-shadow: 0 14px 34px rgba(0, 64, 27, 0.16);
  }
  .account-mobile-affiliates__hero::after {
    content: "";
    position: absolute;
    top: 22px;
    right: 18px;
    width: 98px;
    height: 98px;
    border: 18px solid rgba(166, 245, 175, 0.08);
    border-radius: 999px;
  }
  .account-mobile-affiliates__hero-top,
  .account-mobile-affiliates__tier {
    position: relative;
    z-index: 1;
  }
  .account-mobile-affiliates__hero-top {
  ...
  .account-mobile-affiliates__hero-top > span {
    display: inline-flex;
    min-height: 26px;
    align-items: center;
    padding: 0 12px;
  ...
  .account-mobile-affiliates__hero-top > span::before {
    content: "";
    width: 7px;
    height: 7px;
    margin-right: 6px;
  ...
  .account-mobile-affiliates__hero-top div {
    display: grid;
    justify-items: end;
    color: rgba(255, 255, 255, 0.56);
    line-height: 1.05;
  }
  .account-mobile-affiliates__hero-top small {
    font-size: 0.82rem;
  }
  .account-mobile-affiliates__hero-top strong {
    color: #a8d4ad;
    font-size: 1.55rem;
  }
  .account-mobile-affiliates__hero > p {
    position: relative;
    z-index: 1;
    margin: 0;
  ...
  .account-mobile-affiliates__code {
    position: relative;
    z-index: 1;
    display: grid;
    grid-template-columns: minmax(0, 1fr) auto;
  ...
  .account-mobile-affiliates__code strong {
    min-width: 0;
    overflow: hidden;
    color: #ffffff;
    font-size: 1.05rem;
  ...
  .account-mobile-affiliates__code button {
    display: inline-flex;
    min-height: 42px;
    align-items: center;
    gap: 6px;
  ...
  .account-mobile-affiliates__code button:disabled {
    opacity: 0.58;
  }
  .account-mobile-affiliates__code .account-mobile-affiliates__icon {
    width: 17px;
    height: 17px;
  }
  .account-mobile-affiliates__tier {
  ...
  .account-mobile-affiliates__tier span {
    color: rgba(255, 255, 255, 0.52);
  }
  .account-mobile-affiliates__tier strong {
    color: #a8d4ad;
    font-size: 1.02rem;
    text-transform: capitalize;
  }
  .account-mobile-affiliates__section {
    display: grid;
    gap: 14px;
  }
  .account-mobile-affiliates__section h2 {
    margin: 0 4px;
    color: #252b24;
    font-size: 0.82rem;
    font-weight: 700;
  ...
  .account-mobile-affiliates__stats {
    display: grid;
    grid-template-columns: repeat(2, minmax(0, 1fr));
    gap: 10px;
  }
  .account-mobile-affiliates__stats article {
    display: grid;
    gap: 10px;
    min-height: 132px;
    align-content: center;
  ...
  .account-mobile-affiliates__stats article.is-gold {
    border-color: #d7bc80;
    background: #f8f2e6;
    color: #714e13;
  }
  .account-mobile-affiliates__stats article.is-danger .account-mobile-affiliates__icon {
    color: #c2222b;
  }
  .account-mobile-affiliates__stats span {
    color: currentColor;
    font-size: 0.84rem;
    letter-spacing: 0.05em;
  }
  .account-mobile-affiliates__stats strong {
    color: #111827;
    font-size: 1.45rem;
    line-height: 1;
  }
  .account-mobile-affiliates__stats .account-mobile-affiliates__icon {
    color: #17602d;
  }
  .account-mobile-affiliates__payout {
    display: grid;
    gap: 18px;
    padding: 28px;
    border: 1px solid #c1c9bd;
  ...
  .account-mobile-affiliates__payout-head {
    display: flex;
    justify-content: space-between;
    gap: 16px;
    align-items: center;
  }
  .account-mobile-affiliates__payout h2,
  .account-mobile-affiliates__payout h3 {
    margin: 0;
    color: #111827;
  }
  .account-mobile-affiliates__payout h2 {
  ...
  .account-mobile-affiliates__balance {
    display: grid;
  ...
  .account-mobile-affiliates__balance div {
    display: grid;
    gap: 4px;
  }
  .account-mobile-affiliates__balance span {
    color: #252b24;
    font-size: 0.68rem;
    text-transform: uppercase;
  }
  .account-mobile-affiliates__balance strong {
    color: #003714;
    font-size: 1.28rem;
  }
  .account-mobile-affiliates__bank {
    display: grid;
  ...
  .account-mobile-affiliates__bank > span {
    display: grid;
    width: 46px;
    height: 46px;
    place-items: center;
  ...
  .account-mobile-affiliates__bank strong {
    display: block;
    color: #111827;
    font-size: 1rem;
  }
  .account-mobile-affiliates__bank p,
  .account-mobile-affiliates__payout > p {
    margin: 0;
    color: #343b35;
    font-size: 0.82rem;
    line-height: 1.55;
  }
  .account-mobile-affiliates__bank a {
    color: #003714;
    font-size: 0.72rem;
    font-weight: 900;
    text-decoration: none;
  ...
  .account-mobile-affiliates__invite {
    display: grid;
    grid-template-columns: 36px minmax(0, 1fr);
    gap: 14px;
    padding: 22px;
    border: 1px solid #8de99b;
    border-radius: 8px;
    background: #dcf8e7;
    color: #0b4423;
  }
  .account-mobile-affiliates__invite strong {
    display: block;
    margin-bottom: 8px;
    font-size: 1rem;
  }
  .account-mobile-affiliates__invite p {
    margin: 0;
    color: #2c342e;
    font-size: 0.92rem;
    line-height: 1.45;
  }
  .account-mobile-affiliates__submit {
    position: sticky;
    bottom: 0;
    z-index: 20;
    padding: 18px;
  ...
  .account-mobile-affiliates__submit a {
    display: inline-flex;
    width: 100%;
    min-height: 64px;
    align-items: center;
  ...
  .account-mobile-notifications__title span {
    color: #303832;
    font-size: 0.78rem;
    font-weight: 900;
    letter-spacing: 0.18em;
  ...
  .account-mobile-notifications__profile {
    border-radius: 999px;
  }
  .account-mobile-notifications__profile .account-mobile-notifications__icon {
    width: 28px;
    height: 28px;
    stroke-width: 2.2;
  }
  ...
  .account-mobile-notifications__empty {
    ...
    justify-items: center;
    gap: 22px;
    padding: 52px 40px max(34px, env(safe-area-inset-bottom));
    background: #f5f6f7;
    text-align: center;
  }
  .account-mobile-notifications__empty-mark {
    position: relative;
    display: grid;
    width: 110px;
    height: 110px;
    ...
    background: #dce7fb;
    color: #aab6c0;
    box-shadow: 0 14px 28px rgba(17, 24, 39, 0.035);
  }
  .account-mobile-notifications__empty-mark > .account-mobile-notifications__icon {
    width: 54px;
    height: 54px;
    stroke-width: 1.7;
  }
  .account-mobile-notifications__empty-mark span {
    position: absolute;
    right: 9px;
    bottom: 9px;
    display: grid;
  ...
  .account-mobile-notifications__empty-mark span .account-mobile-notifications__icon {
    width: 18px;
    height: 18px;
    stroke-width: 3;
  }
  ...
  .account-mobile-notifications__empty-action {
    display: inline-flex;
    width: min(100%, 344px);
    min-height: 64px;
    align-items: center;
  ...
  .account-mobile-notifications__empty-action .account-mobile-notifications__icon {
    width: 19px;
    height: 19px;
  }
  .account-mobile-notifications__empty-footer {
    position: relative;
    max-width: none;
    margin-top: 2px;
    color: #7d867d;
  ...
  .account-mobile-notifications__empty-footer::after {
    content: "";
    display: block;
    width: 54px;
    height: 1px;
  ...
  .account-mobile-reviews__title span {
    display: inline-flex;
    align-items: center;
    gap: 8px;
    color: #303832;
  ...
  .account-mobile-reviews__title span .account-mobile-reviews__icon {
    width: 13px;
    height: 13px;
  }
  ...
  .account-mobile-reviews__empty {
    ...
    gap: 22px;
    overflow: hidden;
    padding: 52px 30px max(34px, env(safe-area-inset-bottom));
    background:
      radial-gradient(circle at 50% 36%, rgba(225, 246, 232, 0.92), rgba(245, 246, 247, 0) 42%),
      #f5f6f7;
    text-align: center;
  }
  .account-mobile-reviews__empty-mark {
    position: relative;
    display: grid;
    width: 128px;
    height: 128px;
  ...
  .account-mobile-reviews__empty-mark > .account-mobile-reviews__icon {
    width: 58px;
    height: 58px;
    stroke-width: 2.2;
  }
  .account-mobile-reviews__empty-mark i {
    position: absolute;
    right: -8px;
    bottom: -6px;
    display: grid;
    ...
    background: #00401b;
    color: #ffffff;
    box-shadow: 0 10px 20px rgba(0, 64, 27, 0.24);
  }
  .account-mobile-reviews__empty-mark i .account-mobile-reviews__icon {
    width: 24px;
    height: 24px;
  }
  ...
  .account-mobile-reviews__empty strong {
    color: #7d867d;
    font-size: 0.84rem;
    font-weight: 900;
    letter-spacing: 0.12em;
  ...
  .account-mobile-reviews__empty small {
    width: calc(100% + 60px);
    margin: 18vh -30px 0;
    padding: 28px 24px;
    border-top: 1px solid #c1c9bd;
  ...
  .account-mobile-wishlist__title span {
    color: #303832;
    font-size: 0.88rem;
    font-weight: 900;
    letter-spacing: 0.18em;
  ...
  .account-mobile-wishlist__body.is-empty {
    min-height: calc(100dvh - 64px);
    padding: 0;
  }
  ...
  .account-mobile-wishlist__empty {
    ...
    gap: 22px;
    overflow: hidden;
    padding: 52px 28px max(34px, env(safe-area-inset-bottom));
    background: #f5f6f7;
    text-align: center;
  }
  .account-mobile-wishlist__empty-mark {
    position: relative;
    display: grid;
    width: 128px;
    height: 128px;
  ...
  .account-mobile-wishlist__empty-mark > .account-mobile-wishlist__icon {
    width: 64px;
    height: 64px;
    stroke-width: 2.2;
  }
  .account-mobile-wishlist__empty-mark i {
    position: absolute;
    right: -14px;
    bottom: -8px;
    display: grid;
  ...
  .account-mobile-wishlist__empty-mark i .account-mobile-wishlist__icon {
    width: 25px;
    height: 25px;
  }
  ...
  .account-mobile-wishlist__empty-action {
    display: inline-flex;
    width: min(100%, 344px);
    min-height: 64px;
    align-items: center;
  ...
  .account-mobile-wishlist__empty-categories {
    display: grid;
    grid-template-columns: repeat(2, minmax(0, 1fr));
    gap: 14px;
    width: min(100%, 344px);
  ...
  .account-mobile-wishlist__empty-categories a {
    display: grid;
    justify-items: start;
    gap: 18px;
    min-height: 116px;
  ...
  .account-mobile-wishlist__empty-categories .account-mobile-wishlist__icon {
    width: 30px;
    height: 30px;
    color: #17602d;
  }
  .account-mobile-wishlist__empty small {
    display: grid;
    justify-items: center;
    gap: 8px;
    width: calc(100% + 56px);
  ...
  .account-mobile-wishlist__empty small .account-mobile-wishlist__icon {
    width: 22px;
    height: 22px;
    color: #7d867d;
  }
  .account-mobile-wishlist__empty small span {
    color: #7d867d;
  ...
  .account-mobile-orders__title span {
    color: #303832;
    font-size: 0.72rem;
    font-weight: 900;
    letter-spacing: 0.18em;
  ...
  .account-mobile-orders__body.is-empty {
    min-height: calc(100dvh - 64px);
    padding: 0;
  }
  ...
  .account-mobile-orders__empty {
    ...
    padding: 52px 40px max(34px, env(safe-area-inset-bottom));
    background:
      radial-gradient(circle at 50% 32%, rgba(225, 246, 232, 0.92), rgba(245, 246, 247, 0) 38%),
      #f5f6f7;
    text-align: center;
  }
  .account-mobile-orders__empty-mark {
    position: relative;
    display: grid;
    width: 134px;
    height: 134px;
    place-items: center;
    margin-top: -34px;
    color: rgba(24, 79, 39, 0.08);
  }
  .account-mobile-orders__empty-mark > .account-mobile-orders__icon {
    width: 80px;
    height: 80px;
    stroke-width: 1.6;
  }
  .account-mobile-orders__empty-mark i {
    position: absolute;
    right: 8px;
    bottom: 16px;
    display: grid;
  ...
  .account-mobile-orders__empty-mark i .account-mobile-orders__icon {
    width: 22px;
    height: 22px;
  }
  ...
  .account-mobile-orders__empty-action {
    display: inline-flex;
    width: min(100%, 344px);
    min-height: 64px;
    align-items: center;
  ...
  .account-mobile-orders__empty-action .account-mobile-orders__icon {
    width: 19px;
    height: 19px;
  }
  .account-mobile-orders__empty-footer {
    max-width: none;
    margin-top: 2px;
    color: #7d867d;
    font-size: 0.76rem;
...
.track-order-hero__crumbs a:hover,
...
@media (max-width: 980px) {
  ...
  .hero-grid, .product-detail, .cart-layout, .product-detail-view, .product-detail-loading__top { grid-template-columns: 1fr; }
  .footer-grid {
    grid-template-columns: 1fr;
    gap: 10px;
    padding: 20px 0 14px;
...
/* Admin Stitch clean slate */
body:has(.admin-dashboard) .site-header,
body:has(.admin-manager) .site-header,
body:has(.admin-dashboard) .site-footer,
body:has(.admin-manager) .site-footer {
  display: none;
}
body:has(.admin-dashboard) .app-content,
body:has(.admin-manager) .app-content {
  background: #f4f6f8;
}
.admin-shell.shell {
  width: 100%;
...
.admin-dashboard__topbar p {
  ...
  margin: 0;
  color: #4b4037;
  font: 500 0.95rem/1.3 ui-monospace, SFMono-Regular, Menlo, Consolas, monospace;
}
...
.admin-dashboard__top-actions {
  display: flex;
  align-items: center;
  gap: 14px;
}
.admin-dashboard__sync-button,
.admin-dashboard__top-icon,
...
.admin-dash-card strong {
  color: #00451c;
  font: 950 1.05rem/1.1 ui-monospace, SFMono-Regular, Menlo, Consolas, monospace;
}
...
.admin-dash-card.is-revenue .admin-dash-card__helper,
...
.admin-status-donut {
  ...
  place-items: center;
  border-radius: 999px;
  background: conic-gradient(#237d3b 0 var(--delivered), #ec91a2 var(--delivered) 86%, #ba2020 86% 100%);
  position: relative;
}
.admin-status-donut::after {
  content: "";
  position: absolute;
  inset: 28px;
  border-radius: inherit;
...
.admin-status-donut strong { font-size: 1.15rem; }
.admin-status-donut span { margin-top: 28px; font-size: 0.62rem; }
...
.admin-status-donut__legend strong { color: #167236; font-size: 0.95rem; }
.admin-viz-bars { display: grid; gap: 18px; }
.admin-viz-bar-row {
  grid-template-columns: minmax(90px, 1fr) minmax(90px, 1.6fr) 42px;
  align-items: center;
}
.admin-viz-bar-row span { color: #2d302d; font-weight: 500; }
.admin-viz-bar-row strong { text-align: right; color: #111827; }
.admin-viz-bar-track {
  height: 8px;
  overflow: hidden;
  border-radius: 999px;
...
.admin-viz-bar-row:nth-child(3) .admin-viz-bar-track i { background: #843143; }
.admin-dash-panel {
  min-height: 338px;
  display: grid;
...
.admin-dash-panel__head > span:not(.admin-dash-panel__count) {
  color: #4b4037;
...
.admin-dash-list { display: grid; align-content: start; }
.admin-dash-row {
  min-width: 0;
  display: grid;
...
.admin-dash-row:nth-child(even) { background: #f8f2e6; }
.admin-dash-row strong { color: #111827; font-weight: 850; }
.admin-dash-row p { margin: 4px 0 0; color: #665d52; font-size: 0.82rem; }
.admin-dash-panel__footer {
  min-height: 44px;
  display: grid;
  place-items: center;
  margin: 16px;
...
.admin-dash-shortcut--mobile-action,
...
.admin-dash-shortcuts h2 { display: none; }
.admin-dash-shortcut {
  min-height: 88px;
  display: grid;
  place-items: center;
...
.admin-dash-shortcut span { display: none; }
.admin-dash-shortcut strong { font-weight: 500; }
.admin-chip,
.admin-order-status,
.admin-order-payment {
  min-height: 24px;
...
.admin-order-payment.is-success { background: #dcfce7; color: #176533; }
.admin-chip.is-warning,
.admin-order-status.is-warning,
.admin-order-payment.is-warning { background: #fff1d1; color: #a06100; }
.admin-chip.is-danger,
.admin-order-status.is-danger,
.admin-order-payment.is-danger { background: #ffe4e4; color: #b42318; }
.admin-chip.is-neutral,
.admin-order-status.is-neutral,
.admin-order-payment.is-neutral { background: #eef2f7; color: #4b5563; }
.admin-hero {
  display: grid;
  grid-template-columns: minmax(0, 1fr) auto;
  align-items: center;
...
.admin-hero h1 { margin: 0; color: #111827; font-size: 1.24rem; }
.admin-hero__badge {
  display: inline-flex;
  min-height: 34px;
  align-items: center;
...
.admin-hero__badge span { display: none; }
...
.admin-toolbar {
  display: grid;
  grid-template-columns: minmax(220px, 1fr) repeat(auto-fit, minmax(130px, auto));
  gap: 12px;
  align-items: center;
}
.admin-toolbar .field,
.admin-inline-control .field,
...
.primary-button,
.primary-link { border: 1px solid #00451c; background: #00451c; color: #fff; }
.ghost-button { border: 1px solid #00451c; background: #fff; color: #00451c; }
.danger-button { border: 1px solid #c91f1f; background: #fff; color: #c91f1f; }
...
.admin-manager--orders #admin-filters-toolbar-body { display: block; }
.admin-manager--orders .admin-toolbar {
  grid-template-columns: minmax(280px, 1fr) 46px auto auto;
}
...
.admin-manager--orders .admin-toolbar .ghost-button:nth-of-type(2),
.admin-manager--orders .admin-toolbar .ghost-button:nth-of-type(3),
.admin-manager--orders .admin-toolbar .ghost-button:nth-of-type(4) {
  display: none;
}
...
.admin-orders-metric strong {
  color: #111827;
  font-size: 1.08rem;
  font-weight: 850;
}
.admin-orders-metric small { color: #176533; font-weight: 700; }
.admin-orders-metric--bars div,
.admin-orders-metric--flow div {
  height: 50px;
  display: flex;
  align-items: end;
  gap: 4px;
}
.admin-orders-metric--bars i {
  display: block;
  max-width: 54px;
  height: 48px;
  background: #00451c;
}
.admin-orders-metric--bars i:nth-child(2) { height: 32px; background: #237d3b; }
.admin-orders-metric--bars i:nth-child(3) { height: 6px; background: #c91f1f; }
.admin-orders-metric--bars i:nth-child(4) { height: 12px; background: #a7f2b0; }
.admin-orders-metric--flow div {
  height: 20px;
  align-items: stretch;
  overflow: hidden;
...
.admin-orders-metric--flow i { display: block; background: #237d3b; }
.admin-orders-metric--flow i:nth-child(2) { background: #00451c; }
.admin-orders-metric--flow i:nth-child(3) { background: #d61f1f; }
...
.admin-manager--orders .admin-record-list::before {
  ...
  display: grid;
  grid-template-columns: 1.2fr 0.8fr 0.8fr 1fr 0.8fr 0.9fr;
  gap: 20px;
  padding: 22px 30px;
  background: #f8f2e6;
  color: #111827;
...
.admin-order-row--summary {
  width: 100%;
  display: grid;
  grid-template-columns: 1.2fr 0.8fr 0.8fr 1fr 0.8fr 0.9fr 36px;
  gap: 20px;
  align-items: center;
  padding: 28px 30px;
}
...
.admin-order-mobile-summary { display: none; }
...
.admin-order-proof-link { color: #00451c; font-weight: 900; }
.admin-order-items { min-width: 0; display: grid; gap: 16px; }
...
.admin-order-line-item {
  min-width: 0;
  display: grid;
  grid-template-columns: 56px minmax(0, 1fr) 70px 130px;
  gap: 16px;
  align-items: center;
  padding: 16px 20px;
  border-bottom: 1px solid #dedbd4;
...
.admin-order-line-item__icon img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}
.admin-order-line-item div { min-width: 0; }
.admin-order-line-item strong { min-width: 0; color: #00451c; overflow-wrap: anywhere; }
.admin-order-line-item small,
.admin-order-line-item span { display: block; color: #665d52; font-size: 0.8rem; }
.admin-order-line-item > strong:last-child { text-align: right; color: #111827; }
...
.admin-order-actions {
  display: grid;
  grid-template-columns: 180px 180px minmax(240px, 1fr) 96px minmax(160px, auto) minmax(150px, auto) minmax(170px, auto);
  gap: 14px;
  align-items: end;
  padding: 26px 30px;
  margin: 0 -30px;
...
.admin-order-actions .admin-inline-control .field { background: #fff; border-color: #dedbd4; }
@media (max-width: 1180px) {
  .admin-shell .admin-layout { grid-template-columns: 240px minmax(0, 1fr); }
  .admin-orders-metrics { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .admin-order-detail-grid { grid-template-columns: 1fr; }
  .admin-order-actions { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .admin-order-eta,
  .admin-order-save-eta,
  .admin-order-mark-paid,
  .admin-order-delivered,
  .admin-order-delete { grid-column: auto; }
}
@media (max-width: 760px) {
  body:has(.admin-dashboard) .app-content,
  body:has(.admin-manager--orders) .app-content { background: #f5f6f7; }
  ...
  .admin-orders-mobile-head { grid-template-columns: 38px minmax(0, 1fr) 38px; }
  ...
  .admin-dashboard-mobile-menu { display: block; }
  .admin-dashboard-mobile-menu__backdrop { position: fixed; inset: 0; z-index: 100; border: 0; background: rgba(0,0,0,.35); }
  ...
  .admin-dashboard-mobile-menu__head { display: flex; justify-content: space-between; align-items: center; padding-bottom: 12px; color: #00451c; font-weight: 950; }
  .admin-dashboard-mobile-menu__head button { border: 1px solid #d8ded8; background: #fff; border-radius: 6px; padding: 8px 10px; }
  .admin-dashboard-mobile-menu__panel a { min-height: 44px; display: grid; grid-template-columns: 24px 1fr; align-items: center; gap: 12px; color: #111827; font-weight: 750; }
  .admin-dashboard__topbar,
  .admin-viz-grid,
  .admin-hero,
  ...
  .admin-manager--orders > .admin-collapsible.panel,
  .admin-orders-metrics,
  .admin-order-row .admin-order-payment,
  .admin-order-row .admin-order-date,
  ...
  .admin-dash-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
  .admin-dash-card { min-height: 110px; padding: 16px; border-radius: 3px; box-shadow: none; }
  .admin-dash-card p { font-size: .72rem; letter-spacing: .08em; }
  .admin-dash-card strong { font-size: 1.45rem; }
  .admin-dash-card__helper { display: none; }
  .admin-dashboard__message-callout {
    display: grid;
  ...
  .admin-dashboard__message-callout > span { width: 42px; height: 42px; display: grid; place-items: center; border-radius: 12px; background: #ffdbe4; color: #4b0d18; }
  .admin-dashboard__message-callout strong { display: block; color: #f7b6c3; }
  .admin-dashboard__message-callout p { margin: 4px 0 0; color: #f8d1da; }
  .admin-dashboard__message-callout a { min-height: 42px; display: grid; place-items: center; border-radius: 3px; background: #fff; color: #cc7d95; font-weight: 850; }
  .admin-dash-panels--overview { grid-template-columns: 1fr; gap: 16px; }
  .admin-dash-panel { min-height: 0; border-radius: 3px; box-shadow: none; }
  .admin-dash-panel__head { min-height: 40px; padding: 12px 16px; background: #eef3ff; }
  .admin-dash-panel__head h2 { font-size: .86rem; text-transform: uppercase; font-weight: 500; }
  .admin-dash-row { grid-template-columns: minmax(0,1fr) auto; padding: 14px 16px; }
  .admin-dash-row > div:nth-child(2) { display: none; }
  .admin-dash-panel--users .admin-dash-row { grid-template-columns: 42px minmax(0, 1fr) auto; }
  .admin-dash-panel--users .admin-dash-row > div:nth-child(2) { display: block; }
  .admin-dash-panel--users .admin-dash-row > div:last-child { display: none; }
  .admin-dash-panel__footer { margin: 0; min-height: 54px; border: 0; border-top: 1px solid #d8ded4; border-radius: 0; background: #e8f8ec; }
  .admin-dashboard__insights { display: grid; gap: 14px; }
  .admin-dashboard__insights h2,
  .admin-dash-shortcuts h2 { display: block; color: #4b4037; font-size: .9rem; font-weight: 500; letter-spacing: .16em; text-transform: uppercase; }
  .admin-dashboard__insights article { display: grid; gap: 14px; padding: 16px; border-radius: 3px; }
  .admin-dashboard__insights div { display: flex; justify-content: space-between; gap: 12px; }
  .admin-dashboard__insights i { height: 8px; border-radius: 999px; overflow: hidden; background: #e8eefb; }
  .admin-dashboard__insights b { display: block; height: 100%; border-radius: inherit; background: #176533; }
  .admin-dash-shortcuts { display: grid; gap: 14px; }
  .admin-dash-shortcuts__grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
  .admin-dash-shortcut { min-height: 112px; border-radius: 3px; }
  .admin-dash-shortcut:nth-child(-n+6) { display: none; }
  .admin-dash-shortcut--mobile-action { display: grid; }
  .admin-manager--orders { padding-inline: 24px; }
  .admin-manager--orders .admin-record-list {
    display: grid;
    gap: 26px;
    border: 0;
  ...
  .admin-manager--orders .admin-record-list::before { content: none; }
  .admin-record--order {
    border: 1px solid #cbd3c7;
    border-radius: 22px;
    background: #fbfbff;
    box-shadow: 0 5px 14px rgba(27,25,22,.08);
    overflow: hidden;
  }
  .admin-order-row--summary {
    grid-template-columns: minmax(0,1fr) auto;
  ...
  .admin-order-id { font-size: 1.05rem; }
  .admin-order-customer { grid-column: 1; font-size: 1.15rem; }
  .admin-order-status { grid-column: 2; grid-row: 1; background: #a7f2b0; color: #184f27; font-size: 1rem; letter-spacing: .08em; }
  .admin-order-total { grid-column: 2; grid-row: 2; font-size: 1.05rem; text-align: right; }
  .admin-order-detail { padding: 0 26px 26px; background: #fbfbff; }
  .admin-order-mobile-summary { display: none; }
  .admin-order-detail-grid { display: block; }
  .admin-order-info { padding: 22px 0 0; border: 0; border-top: 1px solid #cbd3c7; border-radius: 0; background: transparent; }
  .admin-order-info dl { grid-template-columns: 1fr 1fr; gap: 16px; }
  .admin-order-info dd { font-size: .9rem; }
  .admin-order-items { margin-top: 18px; }
  .admin-order-items__table { border: 0; background: #f7f8f6; }
  .admin-order-line-item { grid-template-columns: minmax(0,1fr) auto; min-height: 52px; padding: 12px 14px; }
  .admin-order-line-item__icon,
  .admin-order-line-item small,
  .admin-order-line-item span { display: none; }
  .admin-order-line-item strong { font-size: .98rem; }
  .admin-order-actions { grid-template-columns: 1fr 1fr; gap: 14px; padding: 18px 0 0; margin: 0; border-top: 0; background: transparent; }
  .admin-order-eta { grid-column: 1; }
  .admin-order-save-eta { grid-column: 2; align-self: end; }
  .admin-order-mark-paid,
  .admin-order-delivered,
  .admin-order-delete { grid-column: 1 / -1; }
  .admin-order-mark-paid,
  .admin-order-delivered { min-height: 64px; border-radius: 14px; font-size: 1.15rem; }
  .admin-order-delete { min-height: 60px; border: 0; border-top: 1px solid #cbd3c7; border-radius: 0; background: transparent; font-size: 1rem; }
}
@media (max-width: 420px) {
  .admin-manager--orders { padding-inline: 18px; }
  .admin-order-row--summary { padding: 22px; }
  .admin-order-detail { padding-inline: 22px; }
  .admin-order-info dl { gap: 14px; }
  .admin-order-actions { gap: 12px; }
}
`;
