...
export default function CheckoutPaymentPage() {
  ...
  if (!items.length && transitionStage === "idle") {
    return (
      <main className="shell page-section checkout-payment-route">
        ...
        <section className="cart-empty-state" aria-labelledby="payment-empty-title">
          <div className="cart-empty-state__card">
            ...
            <h2 id="payment-empty-title">Your cart is empty</h2>
            <p>
  ...
  return (
    <main className="shell page-section checkout-payment-route">
      ...
      <header className="checkout-payment-mobile-bar">
        <button type="button" className="checkout-payment-mobile-bar__back" onClick={() => router.push("/checkout")} aria-label="Back to billing details">
                  ...
                  <div className="checkout-payment__upload-card">
                    ...
                    {form.paymentProofUrl ? (
                      <div className="checkout-payment__proof-preview">
                        ...
                        <button type="button" className="checkout-payment__secondary checkout-payment__secondary--danger" onClick={clearProof}>
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M5 7h14M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2m1 0-.7 12.1a1 1 0 0 1-1 .9H8.7a1 1 0 0 1-1-.9L7 7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
