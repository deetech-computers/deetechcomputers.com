      ...
      <nav class="navbar">
        <div class="container nav-container">
          <a class="nav-logo" href="${basePrefix}index.html">
            <img src="${basePrefix}assets/img/logo.png" alt="Deetech Computers" class="logo-image" width="160" height="56" loading="lazy" decoding="async" />
          </a>
          ...
          <div class="nav-icons">
            ...
            <button class="nav-icon search-toggle" aria-label="Search">
              <img class="icon-img" src="${basePrefix}assets/img/icons/search.png" alt="" width="24" height="24" loading="lazy" decoding="async" />
            </button>` : ""}
      ...
      <div class="mobile-menu-overlay" id="mobileMenu">
        <div class="mobile-menu-content" role="dialog" aria-modal="true" aria-label="Mobile menu">
          <button class="mobile-menu-close" id="mobileMenuClose" type="button" aria-label="Close menu">
            <img class="icon-img" src="${basePrefix}assets/img/icons/x.png" alt="" width="24" height="24" loading="lazy" decoding="async" />
          </button>
          <div class="mobile-menu-header">
            <a class="mobile-profile-card" href="${basePrefix}account.html">
              <div class="mobile-profile-left">
                <img class="mobile-profile-avatar" src="${basePrefix}assets/img/logo.png" alt="Deetech logo" width="72" height="72" loading="lazy" decoding="async" />
            ...
            .map((p) => {
              ...
              return `
                <a class="search-product-item" href="product.html?id=${encodeURIComponent(productId)}">
                  <img src="${imageSrc}" alt="${p.name}" width="72" height="72" loading="lazy" decoding="async" />
                  <div>
